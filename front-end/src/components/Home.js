    ...
    return (
        ...
        <div className="recipe-recommendations">
            ...
            <div className="recipe-grid">
                {["Shrimp Pasta", "Basil Pasta", "Garlic Butter Pasta", "Tomato Pasta"].map((recipe, index) => (
